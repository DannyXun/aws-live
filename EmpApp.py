...
@app.route("/portfolio_yy", methods=['GET', 'POST'])
def portfolio_yy(): 
    return render_template('portfolio_yy.html')

@app.route("/portfolio_jy", methods=['GET', 'POST'])
def portfolio_jy(): 
    return render_template('portfolio_jy.html')

@app.route("/portfolio_cx", methods=['GET', 'POST'])
def portfolio_cx(): 
